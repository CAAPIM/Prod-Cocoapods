Pod::Spec.new do |s|
    ...
    s.platform          = :ios, '9.0'
    s.requires_arc      = true
    s.source            = {:http => 'https://github.com/CAAPIM/iOS-MAS-Connecta/releases/download/1.7.00/MASConnecta.zip?raw=true'}
    s.vendored_frameworks = 'MASConnecta.framework'
    s.dependency 'MASFoundation', '1.7.00'
    s.dependency 'MASIdentityManagement', '1.7.00'
end
